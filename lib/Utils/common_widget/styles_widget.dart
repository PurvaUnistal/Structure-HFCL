...
class Styles {
  ...
  static TextStyle title = TextStyle(fontSize: 12, color: AppColor.appBlue, fontWeight: FontWeight.bold);
  ...
  static TextStyle labels =  TextStyle(fontWeight: FontWeight.w400, fontSize: 12, color: AppColor.appBlue);
